...
<jsp:include page="left_panel.jsp"></jsp:include>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="container" >  
        <h4 class="principTitle"><strong>Ajouter Vol</strong></h4>
        <br>
         <form  method="post" action="GestionVol">
                 ...
                 <table   width="100%" align="center">
                  <tr>
                    ...
                    <td width="30%">
                <input class="dateDepart" type="date" required="required" name="dateDepart">
              </td>
              <td width="20%" align="center">
                <label for="dateArrivee">Date Arrivée</label>
               </td>
               <td width="30%"> 
                      <input class="dateArrivee" type="date" required="required" name="dateArrivee">
              </td>
                  ...
                  <tr>
                    ...
                    <td width="30%">
                       <input type="text" name="heureDepart" pattern="[0-2][0-9]:[0-5][0-9]:[0-5][0-9]" required="required" placeholder="--:--:--">
                    </td>
                    ...
                    <td width="30%">
                       ...
                       <input type="text" name="heureArrivee" pattern="[0-2][0-9]:[0-5][0-9]:[0-5][0-9]" required="required" placeholder="--:--:--">
                  ...
                  <tr>
                    ...
                    <td width="32%">
                      <input type="text"  name="prix" class="prix" required="required"><span>DH</span>
                   </td>
                  ...
                  <tr>
                    ...
                    <td width="30%">
                      <input type="number" min="1" max="31" name="duree" class="duree" required="required">
                    </td>
                    <td width="20%" align="center">
                      <label for="aéropD">Aéroport départ</label>
                    </td>
                    <td width="30%">
                    <select name="aeroDnom" id="pet-select">
                  ...
                  <tr>
                    ...
                    <td width="30%">
                       <select name="aeroAnom" id="pet-select">
                      <c:forEach  var="aerop" items="${ aerop }" >
							<option ><c:out value="${ aerop.nom }"></c:out></option>   
						</c:forEach> 
                      </select>
                    ...
                    <span style="color:green">${form.resultat}</span></td>
                    <td><input type="submit" name="" value="Ajouter Vol"></td>
                  </tr>
                </table>
