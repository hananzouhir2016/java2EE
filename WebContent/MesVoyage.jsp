      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form>
                <h6 class="heading-small text-muted mb-4">Voyages Validees</h6>
                <div class="pl-lg-4">
									...
									<div class="LegInfo_legInfo__2UyXp" style="flex-flow: initial;font-weight: initial;">
										<div class="LegInfo_routePartialDepart__Ix_Rt">
											...
											<span class="BpkText_bpk-text_2VouB BpkText_bpk-text--base_3REoZ">
												...
												<span class="BpkText_bpk-text_2VouB BpkText_bpk-text--base3REoZ LegInfo_routePartialCityTooltip_Ao7U-">${vol.dateDepart}</span>
											</span>
										</div>
