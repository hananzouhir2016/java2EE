...
<html class="no-js"  lang="en">
	...
	<body>
		...
		<!--travel-box end-->
		<div class="container" id="tm-section-3">
			<div class="side-bar col-md-3">
				<div class="range">
					<h3 class="agileits-sear-head">Prix</h3>
					<br>
				<div class="co-md-9 col-sm-12">
				...
				<!-- Escales -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Escales</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Direct</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">1 escale</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">2+ escale</span>
						</li>
					</ul>
				</div>
				<!-- //Escales -->
				...
				<div class="co-md-9 col-sm-12">
					<div class="travel-filter">
						<div class="info_widget">
							<div class="price_filter">
								<div id="time-range" style="width:280px !important;height:40px !important;margin-left:25px;">
									<p><span class="slider-time ">9:00AM</span> - <span class="slider-time2">5:00PM</span>
									</p>
				...
				<!-- //heure de depart range -->
				<!-- Companie range -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Compagnie aerienne</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Royal Air Maroc</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Iberia</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Combinaison de compagnie</span>
						</li>
						
					</ul>
				</div>
				<div class="left-side">
					<h3 class="agileits-sear-head">Precotions covid-19</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
				...
				<!-- Aeroports -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Aeroports de depart</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Agadir</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Rabat</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Casablanca</span>
						</li>
						
					</ul>
				</div>
				<div class="left-side">
					<h3 class="agileits-sear-head">Aeroports d'arrivee</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Agadir</span>
			...
			<div class="tab-content clearfix col-md-9" style="display: block !important;">
				...
				<div class="tab-pane" id="4a" style="display: block !important;">
                    <!-- Current Active Tab WITH "show active" classes in DIV tag -->
                        <div class="tm-recommended-place-wrap" style="display: block !important;">
                            <div class="tm-recommended-place"  style="height: 240px;">
    ...
    box-shadow: 0 5px 20px rgba(14,15,18,.2);">plus de vols</a>
                    </div> <!-- tab-pane -->
                </div>
			 </div>        
	   </div>
