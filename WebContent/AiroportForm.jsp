...
<jsp:include page="left_panel.jsp"></jsp:include>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <br> <br>  
        <h4 class="principTitle"><strong>Ajouter Aéroport</strong></h4>
        <p></p>
    <form method="post" action="GestionAe">
        <div class="mb-3">
            <label for="nom" class="form-label">LIBELLÉ AEROPORT</label>
        ...
        <div class="mb-3">
        <button type="submit" class="btn btn-primary btn-block">Ajouter Aéroport</button>
        </div>
      </form>
   </div>
