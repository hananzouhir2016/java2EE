        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                ...
                <h6 class="heading-small text-muted mb-4">Voyages en attente</h6>
                <div class="pl-lg-4">
					...
					<div class="tm-recommended-place-wrap" style="display: block !important;">
						<div class="tm-recommended-place" style="margin-bottom:0px;border-radius:5px 5px 5px 5px;">
							...
							<div style="background-color: #00d8ff;width: 400px;padding:20px;border-radius:5px 5px 5px 5px;">
								...
								<button class="btn default" style="color:white;background-color: #8898aa;margin-bottom:2.5px;width:200px;"
						        ...
						        <button class="btn default" style="color:white;background-color: #8898aa;margin-bottom:2.5px;width:90px;margin-left:20px;"onclick="closeFor(document.getElementById('${ reservation.id}'))">annuler</button>
					            </form>
						        </div>
						   </div>                        
						</div>
