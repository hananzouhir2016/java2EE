							...
							<div class="single-special-offer">
								<div class="single-special-offer-txt">
                                    ...
                                    <div   id="myDIV" style="height: auto; overflow: visible; transition: height 200ms ease 0s;display:none;width: 100%; "  >
                                        <div style="">
                                            <div class="LegSegmentSummary_container__1AUr4 LegSegmentSummary_containerConfigBackground__2Qp5O">
                                                
                                                <div class="LegSegmentDetails_container__3wZa8">
                                                    
                                                    <div class="LegSegmentDetails_segmentDetails__Ni1c-"  style="  margin-left:40px;">
                                                        <div class="Timeline_circles__1CHmt">
                                                            <div class="Timeline_track__9T1lp ">
                            
                                                            </div>
                                                        </div>
                                                        <div class="Times_segmentTimes__2D_aD">
                                                            <div>
                                                                <span class="BpkText_bpk-text__2VouB BpkText_bpk-text--base__3REoZ">
                                                                    16:20
                                                                </span>
                                                        ...
                                                        <div class="Routes_routes__2_FZu">
                                                            <span class="BpkText_bpk-text__2VouB BpkText_bpk-text--base__3REoZ">
                                                                AGA
                                                                &nbsp;
                                                                Agadir
...
Femme                                                                </label>
                                                    ...
                                                    <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                        ...
                                                        <input class="input100" type="text" name="email" placeholder="Entrez le nom ">
                                                    </div>
                                    
                                    
                                                    <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Enter Your Email (e@a.x)">
                                                        <span class="label-input100">Prenom</span>
                                                        <input class="input100" type="text" name="email" placeholder="Entrez le prenom ">
                                                    </div>
                                            ...
                                            <div class="wrap-contact100 " style="margin: auto;">
                                                <form class="contact100-form validate-form">
                                                    ...
                                                    <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                        ...
                                                        <input class="input100" type="text" name="email" placeholder="Entrez votre Telephone ">
                                                    </div>
                                    
                                    
                                                    <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Enter Your Email (e@a.x)">
                                                        <span class="label-input100">Ville</span>
                                                        <input class="input100" type="text" name="email" placeholder="Entrez votre Ville ">
                                                    </div>
                                    
                                                    <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                        <span class="label-input100">Adresse</span>
                                                        <input class="input100" type="text" name="phone" placeholder="Entrez votre Adresse">
                                                    </div>
                                                    ...
                                                    <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                        ...
                                                        <input class="input100" type="text" name="email" placeholder="Entrez votre code postal">
                                                    </div>
